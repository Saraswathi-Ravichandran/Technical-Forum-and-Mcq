...
<div class="container">
    ...
    <div class="row">
        <div class="col-2">
            <button class="btn btn-primary"><a href="solved_mcq.php" class="text-light">solved Mcq</a></button>
        </div>
        <div class="col-10"><div class="row mt-4">
        <?php
        ...
        if($c==0){
       echo '
                <button class="col-4 mt-4 offset-1  btn btn-info" ><a href="review_exam.php?q=quiz&eid='.$eid.'&title='.$title.'" class="text-light">'.$title.'</a></button>
                
            ';$c=1;}
            else{
                echo '
                <button class="col-4 mt-4 btn btn-secondary" ><a href="review_exam.php?q=quiz&eid='.$eid.'&title='.$title.'" class="text-light">'.$title.'</a></button>';
            $c=0;}
        }?>
        </div></div>
    </div>
